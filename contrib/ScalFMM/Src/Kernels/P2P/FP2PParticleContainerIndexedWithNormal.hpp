...
#ifndef FP2PPARTICLECONTAINERINDEXEDWITHNORMAL_HPP
#define FP2PPARTICLECONTAINERINDEXEDWITHNORMAL_HPP

#include "../../Containers/FVector.hpp"

#include "FP2PParticleContainerWithNormal.hpp"
#include "Components/FParticleType.hpp"

template<class FReal, int NRHS = 1, int NLHS = 1, int NVALS = 1>
class FP2PParticleContainerIndexedWithNormal : public FP2PParticleContainerWithNormal<FReal, NRHS,NLHS,NVALS> {
    typedef FP2PParticleContainerWithNormal<FReal, NRHS,NLHS,NVALS> Parent;
...
#endif // FP2PPARTICLECONTAINERINDEXEDWITHNORMAL_HPP

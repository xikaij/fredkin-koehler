...
int main(int argc, char* argv[]){
    ...
    typedef FTaylorCellPODPole<FReal,P,1>  GroupCellUpClass;
    typedef FTaylorCellPODLocal<FReal,P,1> GroupCellDownClass;
    typedef FTaylorCellPOD<FReal,P,1>      GroupCellClass;
